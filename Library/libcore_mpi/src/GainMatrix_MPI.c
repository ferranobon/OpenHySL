...
void IGainMatrix_MPI (PMatrixVector_t *const IGain, PMatrixVector_t *const Mass, PMatrixVector_t *const Damp, PMatrixVector_t *const Stiff, const Scalars_t Const) {
