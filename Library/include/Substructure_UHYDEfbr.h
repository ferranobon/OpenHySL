...
typedef struct UHYDEfbrSim {
     hysl_float_t u0c_old;    /*!< \brief Old displacement (the one from the previous sub-step. */
     hysl_float_t q;          /*!< \brief Displacement in the device. */
     hysl_float_t qyield;     /*!< \brief Yield displacement. */
     hysl_float_t qplastic;   /*!< \brief Plastic displacement. */
     hysl_float_t k;          /*!< \brief Initial stiffness. */
 ...
 */
void Substructure_SimUHYDE_1D( const hysl_float_t u0c, const hysl_float_t DeltaT, UHYDEfbrSim_t *const Sub, hysl_float_t *const Friction_Force );
 ...
 */
void Substructure_SimUHYDE_1D_Init( const hysl_float_t qyield, const hysl_float_t yield_factor, const hysl_float_t Friction, const char *Description, UHYDEfbrSim_t *const Sub );
