...
void Substructure_Remote_OpenFresco (const int Socket, const int WhatToDo, const uint32_t Size, const hysl_float_t *const Data_To_Send, hysl_float_t *const Data_To_Receive) {

    /* Local Variables */
    static uint32_t i, iData[OF_INFO_DATA_LENGTH];
    static uint32_t DataSize = OF_DATA_SIZE;
