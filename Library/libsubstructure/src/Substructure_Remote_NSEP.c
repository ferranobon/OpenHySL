...
void Substructure_Remote_NSEP (const Remote_t *const Remote, const int WhatToDo, const hysl_float_t Time, const unsigned int Size, const hysl_float_t *const Data_To_Send,
        hysl_float_t *const Data_To_Receive) {
...
void Substructure_Remote_NSEP_LoginServer (const Remote_t *const Remote, const char *const Send_Buffer, char *const Receive_Buffer) {
...
void Substructure_Remote_NSEP_SendLoginInformation (const int Socket, const char *const Name, const char *const Password, const char *const Send_Buffer) {
...
void Substructure_Remote_NSEP_ReceiveLoginInformation (const int Socket, int *const NSEP_Type, int *const Error_Code, char *const Receive_Buffer) {
