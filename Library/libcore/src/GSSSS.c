...
void GSSSS_EffectiveForce_AForm (const MatrixVector_t *const Mass, const MatrixVector_t *const Damp, const MatrixVector_t *const Stiff, const MatrixVector_t *const DispT,
        const MatrixVector_t *const VelT, const MatrixVector_t *const AccT, MatrixVector_t *const Tempvec, const TIntegration_GSSSS_t *const GSSSS, const hysl_float_t DeltaT,
    ...
    hysl_float_t Alpha = GSSSS->A1W1 * DeltaT;
    ...
    hysl_symv(&uplo, &Tempvec->Rows, &Alpha, Mass->Array, &Tempvec->Rows, AccT->Array, &incx, &Beta, Eff_ForceT->Array, &incy);
}

void GSSSS_EffectiveForce_AForm_PS (const MatrixVector_t *const Mass, const MatrixVector_t *const Damp, const MatrixVector_t *const Stiff, const MatrixVector_t *const DispT,
        const MatrixVector_t *const VelT, const MatrixVector_t *const AccT, MatrixVector_t *const Tempvec, const TIntegration_GSSSS_t *const GSSSS, const hysl_float_t DeltaT,
        MatrixVector_t *const Eff_ForceT) {
    int32_t incx = 1;
    int32_t incy = 1; /* Stride in the vectors */
     ...
     * -A5W2)*DeltaT*Acc) -(1-A6W1)*M*Acc= Eff_Force - (1-A6W1)*M*Acc */
    Alpha = -(1.0 - GSSSS->A6W1) * DeltaT;
    hysl_spmv(&uplo, &Tempvec->Rows, &Alpha, Mass->Array, AccT->Array, &incx, &Beta, Eff_ForceT->Array, &incy);
}

void GSSSS_ComputeDisplacement_AForm (const MatrixVector_t *const DispT, const MatrixVector_t *const VelT, const MatrixVector_t *const AccT, const MatrixVector_t *const AccTdT,
        const TIntegration_GSSSS_t *const GSSSS, const hysl_float_t DeltaT, MatrixVector_t *const DispTdT) {
    int32_t incx = 1;
    int32_t incy = 1; /* Stride in the vectors */
    ...
    hysl_float_t Alpha = GSSSS->l1 * DeltaT;
...
void GSSSS_ComputeVelocity_AForm (const MatrixVector_t *const VelT, const MatrixVector_t *const AccT, const MatrixVector_t *const AccTdT, const TIntegration_GSSSS_t *const GSSSS,
    ...
    hysl_float_t Alpha = (GSSSS->l4 - GSSSS->l5) * DeltaT;
...
void GSSSS_Compute_NewState (const MatrixVector_t *const IGain, const MatrixVector_t *const Eff_ForceT, const MatrixVector_t *const LoadTdT, const MatrixVector_t *const Err_ForceT,
        const MatrixVector_t *const LoadT, const TIntegration_GSSSS_t *const GSSSS, MatrixVector_t *const Tempvec, MatrixVector_t *const VecTdT_0) {
    int32_t incx = 1;
    int32_t incy = 1; /* Stride in the vectors */
    ...
    hysl_float_t Beta = 0.0;
    char uplo = 'L';
    hysl_symv(&uplo, &Tempvec->Rows, &Alpha, IGain->Array, &Tempvec->Rows, Tempvec->Array, &incx, &Beta, VecTdT_0->Array, &incy);
}

void GSSSS_Compute_NewState_PS (const MatrixVector_t *const IGain, const MatrixVector_t *const Eff_ForceT, const MatrixVector_t *const LoadTdT, const MatrixVector_t *const Err_ForceT,
        const MatrixVector_t *const LoadT, const TIntegration_GSSSS_t *const GSSSS, MatrixVector_t *const Tempvec, MatrixVector_t *const VecTdT_0) {
    int32_t incx = 1;
    int32_t incy = 1; /* Stride in the vectors */
    ...
    hysl_float_t Beta = 0.0;
    char uplo = 'L';
    hysl_spmv(&uplo, &Tempvec->Rows, &Alpha, IGain->Array, Tempvec->Array, &incx, &Beta, VecTdT_0->Array, &incy);
}

void GSSSS_ErrorForce_PID (const MatrixVector_t *const Mass, const MatrixVector_t *const Damp, const MatrixVector_t *Stiff, const MatrixVector_t *const AccTdT, const MatrixVector_t *const AccT,
        const MatrixVector_t *const VelT, const MatrixVector_t *const DispT, const MatrixVector_t *const fc, const MatrixVector_t *const LoadTdT, const MatrixVector_t *const LoadT,
        const TIntegration_GSSSS_t *const GSSSS, const hysl_float_t DeltaT, const MatrixVector_t *const Tempvec, const PID_t *const PID, MatrixVector_t *const fe) {

    int32_t incx = 1;
    int32_t incy = 1; /* Stride in the vectors for BLAS routines */

    /* BLAS: tempvec = acct */
    hysl_copy(&Tempvec->Rows, AccT->Array, &incx, Tempvec->Array, &incy);
    /* BLAS: tempvec = acct + A6W1*acctdt = tempvec + A6W1*acctdt */
    hysl_float_t Alpha = GSSSS->A6W1;
...
void GSSSS_ErrorForce_PID_PS (const MatrixVector_t *const Mass, const MatrixVector_t *const Damp, const MatrixVector_t *Stiff, const MatrixVector_t *const AccTdT, const MatrixVector_t *const AccT,
        const MatrixVector_t *const VelT, const MatrixVector_t *const DispT, const MatrixVector_t *const fc, const MatrixVector_t *const LoadTdT, const MatrixVector_t *const LoadT,
        const TIntegration_GSSSS_t *const GSSSS, const hysl_float_t DeltaT, const MatrixVector_t *const Tempvec, const PID_t *const PID, MatrixVector_t *const fe) {
