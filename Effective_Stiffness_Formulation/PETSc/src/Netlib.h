...
void psaxpy_( int *n, float *alpha, float *x, int *ix, int *jx, int *descx, int *incx, float *y, int *iy, int *jy, int *descy, int *incy);

void psgeadd_(char *trans, int *m, int *n, float *alpha, float *a, int *ia, int *ja, int *desca, float *beta, float *c, int *ic, int *jc, int *descc);
void pstradd_( char *uplo, char *trans, int *m, int *n, float *alpha, float *a, int *ia, int *ja, int *desca, float *beta, float *c, int *ic, int *jc, int *descc );
void psgemv_( char *trans, int *m, int *n, float *alpha, float *a, int *ia, int *ja, int *desca, float *x, int *ix, int *jx, int *descx, int *incx, float *beta, float *y, int *iy, int *jy, int *descy, int *incy );
void pssymv_( char *uplo, int *n, float *alpha, float *a, int *ia, int *ja, int *desca, float *x, int *ix, int *jx, int *descx, int *incx, float *beta, float *y, int *iy, int *jy, int *descy, int *incy );
...
void pslacpy_( char *uplo, int *m, int *n, float *a, int *ia, int *ja, int *desca, float *b, int *ib, int *jb, int *descb);
void pslascl_( char *uplo, float *cfrom, float *cto, int *m, int *n, float *a, int *ia, int *ja, int *desca, int *info);
...
void psgetri_( int *n, float *a, int *ia, int *ja, int *desca, int *ipiv, float *work, int *lwork, int *iwork, int *liwork, int *info );
void psgetrf_( int *m, int *n, float *a, int *ia, int *ja, int *desca, int *ipiv, int *info );
#endif
