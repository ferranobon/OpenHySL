...
void Calc_Input_Load_AbsValues( Dense_MatrixVector *const InLoad, const Sp_MatrixVector *const Stif, const Sp_MatrixVector *const Damp, const Sp_MatrixVector *const Mass, const Dense_MatrixVector *const DiagM, const Dense_MatrixVector *const D, const Dense_MatrixVector *const V, const Dense_MatrixVector *const A )
{
...
void Calc_Input_Load_RelValues( Dense_MatrixVector *const InLoad, const Sp_MatrixVector *const Mass, const Dense_MatrixVector *const A )
{
     ...
     static float Alpha, Beta;    /* Constants to use in the BLAS library */
     static char trans = 'N';
     static char matdescra[6] = {'D', 'U', 'N', 'C'};
