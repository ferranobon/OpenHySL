...
typedef struct UHYDEfbrSim {
     HYSL_FLOAT u0c_old;    /*!< \brief Old displacement (the one from the previous sub-step. */
     HYSL_FLOAT q;          /*!< \brief Displacement in the device. */
     HYSL_FLOAT qyield;     /*!< \brief Yield displacement. */
     HYSL_FLOAT qplastic;   /*!< \brief Plastic displacement. */
     HYSL_FLOAT k;          /*!< \brief Initial stiffness. */
 ...
 */
void Substructure_SimUHYDE_1D( const HYSL_FLOAT u0c, const HYSL_FLOAT DeltaT, UHYDEfbrSim_t *const Sub, HYSL_FLOAT *const Friction_Force );
 ...
 */
void Substructure_SimUHYDE_1D_Init( const HYSL_FLOAT qyield, const HYSL_FLOAT yield_factor, const HYSL_FLOAT Friction, const char *Description, UHYDEfbrSim_t *const Sub );
